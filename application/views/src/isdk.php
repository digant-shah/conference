...
class iSDK
{
     ...
     */
    public function cfgCon($name="familylife", $key = "5578d0615a091ed8ddc85d1bdbec34ec", $dbOn = "on", $type = "i")
    {
        ...
        switch ($type) {
            case 'm':
                $this->client = new xmlrpc_client("https://familylife.mortgageprocrm.com/api/xmlrpc");
                break;
            case 'i':
            default:
                if (!isset($appname)) {
                ...
                $this->client = new xmlrpc_client("https://familylife.infusionsoft.com/api/xmlrpc");
                break;
        }
...
public function dsLoad1($tName,$rFields)
    {
        $carray = array(
